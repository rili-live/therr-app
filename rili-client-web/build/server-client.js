...
/******/ 	// eslint-disable-next-line no-unused-vars
/******/ 	var hotCurrentHash = "b941e4807571c04ec1b7";
...
const socket = (state = initialState, action) => {
    ...
    switch (action.type) {
        ...
        case constants_1.SocketServerActionTypes.SEND_MESSAGE:
            return state.setIn(['messages', action.data.roomId], updatedMessageList);
        case constants_1.SocketServerActionTypes.SESSION_MESSAGE:
    ...
    render() {
        return (React.createElement("div", { className: "flex-box" },
            React.createElement("div", { className: "login-container" },
                React.createElement("h1", { className: "text-center" }, "Home"),
                React.createElement("p", null, "Welcome to Rili, where everything is real-time, or at least really close to it."),
                React.createElement("label", { htmlFor: "user_name" }, "Username:"),
                React.createElement(Input_1.default, { type: "text", id: "user_name", name: "userName", value: this.state.inputs.userName, onChange: this.onInputChange, onEnter: this.onButtonClick, translate: this.translate }),
                React.createElement("label", { htmlFor: "passwork" }, "Password:"),
                React.createElement(Input_1.default, { type: "password", id: "password", name: "password", value: this.state.inputs.password, onChange: this.onInputChange, onEnter: this.onButtonClick, translate: this.translate }),
                React.createElement("div", { className: "form-field text-right" },
                    React.createElement(ButtonPrimary_1.default, { id: "login", text: "Login", onClick: this.onButtonClick, disabled: this.isLoginDisabled() })),
                React.createElement("p", { className: "text-center" }, "*This is a pseudo-login form. Actual profile creation and login has not yet been configured."))));
    }
}
