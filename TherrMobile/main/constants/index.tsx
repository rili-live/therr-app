...
const MIN_RADIUS_OF_AWARENESS = 10;
const MAX_RADIUS_OF_AWARENESS = 1000;
const MIN_RADIUS_OF_INFLUENCE = 10;
const MAX_RADIUS_OF_INFLUENCE = 1000;
...
export {
    ...
    MIN_RADIUS_PUBLIC,
    MAX_RADIUS_PUBLIC,
    MIN_RADIUS_OF_AWARENESS,
    MAX_RADIUS_OF_AWARENESS,
    MIN_RADIUS_OF_INFLUENCE,
    MAX_RADIUS_OF_INFLUENCE,
