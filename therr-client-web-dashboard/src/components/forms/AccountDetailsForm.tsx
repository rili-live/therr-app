                    ...
                    <Row>
                        <Col md={6} className="mb-3">
                            <Form.Group id="firstName">
                                ...
                                <Form.Control value={firstName} required type="text" placeholder="Enter your first name" disabled />
                            </Form.Group>
                        </Col>
                        <Col md={6} className="mb-3">
                            <Form.Group id="lastName">
                                <Form.Label>Last Name</Form.Label>
                                <Form.Control value={lastName} required type="text" placeholder="Also your last name" disabled />
                            </Form.Group>
                        </Col>
                    </Row>
