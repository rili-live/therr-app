...
export const ProfileCardWidget = () => (
    <Card border="light" className="text-center p-0 mb-4">
        <div style={{ backgroundImage: 'url(/assets/img/profile-cover.jpg)' }} className="profile-cover rounded-top" />
...
export const ChoosePhotoWidget = (props: { title: any, photo: any }) => {
            ...
            <Card.Body>
                <Row className="d-block d-xl-flex align-items-center">
                    ...
                    <Col xs={12} xl={7} className="px-xl-0">
                        ...
                        <small>This {period}, <FontAwesomeIcon icon={faGlobeEurope} size="xs" /> WorldWide</small>
...
export const CircleChartWidget = (props: any) => {
...
export const BarChartWidget = (props: any) => {
    const {
        title, value, percentage, data = [],
    } = props;
...
export const TeamMembersWidget = () => {
    const TeamMember = (props: any) => {
        const {
            name, statusKey, image, icon, btnText,
        } = props;
        const status = {
...
export const ProgressTrackWidget = () => {
    const Progress = (props: any) => {
        const {
            title, percentage, icon, color, last = false,
        } = props;
