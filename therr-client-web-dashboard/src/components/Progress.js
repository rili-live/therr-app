...
export default (props) => {
    const {
        label, variant, value, type = 'label', size = 'md',
    } = props;
    const finalValue = value || Math.floor(Math.random() * (Math.floor(100) - 20 + 1)) + 20; // generates a random number between 20 and 100
