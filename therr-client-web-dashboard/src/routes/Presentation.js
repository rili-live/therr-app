...
import {
    faBook, faExternalLinkAlt, faTimesCircle, faCheckCircle, faCalendarAlt, faCodeBranch, faShoppingCart, faFolder, faMapMarkedAlt, faPager, faFileCode, faDownload,
} from '@fortawesome/free-solid-svg-icons';
import {
    faBootstrap, faGithub, faJs, faReact, faSass,
} from '@fortawesome/free-brands-svg-icons';
import {
    Col, Row, Card, Image, Button, Container, ListGroup, Tooltip, OverlayTrigger, Form, Navbar, Nav, Badge,
        ...
        return (
            ...
            >
                <li data-toggle="tooltip" data-placement="left" title="Main folder that you will be working with">
                    <FontAwesomeIcon icon={icon || faFolder} className={`${color} me-2`} /> {name}
                </li>
            </OverlayTrigger>
        );
    };
                        ...
                        <Col xs={12} className="text-center">
                            ...
                            <div className="d-flex justify-content-center flex-column mb-6 mb-lg-5 mt-5">
                                <div className="text-center">
                                    <a href="https://business.therr.com" target="_blank" rel="noreferrer">
                ...
                <Container>
                    ...
                    <Row className="mt-6">
                        <Col xs={12} md={6} lg={4} className="mb-5 mb-lg-0">
                            <Card border="light" className="p-4">
                                ...
                                <Button href="https://business.therr.com/" target="_blank" variant="primary" className="w-100 m-0 mt-3 mb-3"><FontAwesomeIcon icon={faDownload} className="me-1" /> Download</Button>
                            </Card>
                        </Col>
                        <Col xs={12} md={6} lg={4} className="mb-5 mb-lg-0">
                    ...
                    <Row className="mt-lg-6">
                        <Col xs={12} className="text-center">
                            ...
                            <div>
                                <Card.Link href="https://business.therr.com/" target="_blank" className="me-3">
                ...
                <Container>
                    <Row>
                        ...
                        <Col xs={6} md={2} className="mb-5 mb-lg-0">
                            ...
                            <ul className="links-vertical mt-2">
                                <li><Card.Link target="_blank" href="https://business.therr.com/blog">Blog</Card.Link></li>
                                <li><Card.Link target="_blank" href="https://business.therr.com/about">About Us</Card.Link></li>
                                <li><Card.Link target="_blank" href="https://business.therr.com/contact">Contact Us</Card.Link></li>
                            </ul>
                        </Col>
                        <Col xs={6} md={2} className="mb-5 mb-lg-0">
                            ...
                            <ul className="links-vertical mt-2">
                                ...
                                <li><Card.Link target="_blank" href="https://business.therr.com/">License</Card.Link></li>
                            </ul>
                        </Col>
                    ...
                    <Row>
                        <Col className="mb-md-2">
                            <Card.Link href="https://business.therr.com" target="_blank" className="d-flex justify-content-center">
