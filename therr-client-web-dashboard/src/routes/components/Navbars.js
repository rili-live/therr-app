...
import {
    Nav, Row, Col, Card, Image, Navbar, Container,
    ...
    <article>
        <Container className="px-0">
            ...
            <Documentation
                ...
                description=""
                scope={{
                    Nav, Card, Navbar, Container, ReactLogo: ReactLogoTransparent, Image,
                }}
  ...
  <Container className="position-relative">
    ...
    <Navbar.Toggle aria-controls="navbar-default-primary" />
            ...
            <Documentation
                ...
                description=""
                scope={{
                    useEffect, useState, Nav, Card, Navbar, Image, Container, ReactLogoPrimary, ReactLogo: ReactLogoTransparent,
                }}
