...
declare -a arr=("therr-client-web" "TherrMobile" "therr-api-gateway" "therr-services/push-notifications-service" "therr-services/maps-service" "therr-services/messages-service" "therr-services/reactions-service" "therr-services/users-service" "therr-services/websocket-service")
for i in "${arr[@]}"; do
    pushd ${i}
    if [ -f package.json ]
    then
