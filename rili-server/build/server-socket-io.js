...
/******/
/******/ 	// Load entry module and return exports
/******/ 	return __webpack_require__(__webpack_require__.s = "XDo8");
/******/ })
/************************************************************************/
/******/ ({
...
const nodes = [
    // Pub
    {
        host: globalConfig["development"].redisPubHost,
        port: globalConfig["development"].redisPubPort,
    },
    // Sub
    {
        host: globalConfig["development"].redisSubHost,
...
const startExpressSocketIOServer = () => {
    ...
    const server = appServer.listen(globalConfig["development"].socketPort, '0.0.0.0', (err) => {
    ...
    io.on('connection', (socket) => {
        ...
        socket.on(Constants.ACTION, (action) => {
            switch (action.type) {
                case constants_1.SocketClientActionTypes.JOIN_ROOM:
            ...
            activeRooms.forEach((room) => {
                ...
                if (parsedResponse && parsedResponse.userName) {
                    ...
                    socket.broadcast.to(room).emit(Constants.ACTION, {
                        type: constants_1.SocketServerActionTypes.LEFT_ROOM,
                        data: {
                            roomId: room,
                            message: {
