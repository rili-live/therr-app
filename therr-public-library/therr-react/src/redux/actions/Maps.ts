...
import MapsService, { IPlacesAutoCompleteArgs, ISearchMomentsArgs } from '../../services/MapsService';
...
const Maps = {
    ...
    searchMoments: (query: any, data: ISearchMomentsArgs = {}) => (dispatch: any) => MapsService
