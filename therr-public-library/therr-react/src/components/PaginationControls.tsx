...
import 'therr-styles/icons.scss'; // eslint-disable-line import/no-unresolved
import 'therr-styles/pagination.scss'; // eslint-disable-line import/no-unresolved
import calculatePages from 'therr-js-utilities/calculate-pages';
